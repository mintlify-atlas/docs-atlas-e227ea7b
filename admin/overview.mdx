---
title: "Debuta Admin Panel: Features and Access"
sidebarTitle: "Overview"
description: "The Debuta admin panel is a web-based dashboard for managing users, moderation, analytics, and support tickets. Served at /admin by the backend."
---
...
<CardGroup cols={2}>
  <Card title="Dashboard" icon="chart-bar">
    Real-time KPI cards showing online users, total users, new registrations today and this week, total matches, messages sent, pending reports, active associates, and open support tickets. Includes a registration growth line chart (configurable to 7, 30, or 90 days) and a gender distribution doughnut chart. Stats refresh automatically every 30 seconds.
  </Card>
