...
description: "Endpoints for liking and disliking users, listing mutual matches with message previews, and managing date suggestions: accept, reject, or propose a new venue."
---
