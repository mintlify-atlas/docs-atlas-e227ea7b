...
sidebarTitle: "Chat"
description: "REST endpoints for fetching paginated message history between matched users and uploading chat images to Cloudinary. Real-time messaging uses Socket.io, not REST."
---
